...
# 0 "<command-line>" 2
# 1 "tests/class.c"
# 1 "tests/../src/class.h" 1


# 1 "tests/../src/utils.h" 1
...
# 4 "tests/../src/utils.h" 2
# 4 "tests/../src/class.h" 2
...
void test_class_variables_init(){
    Base object;
    int *a_ptr = &object.a;
    Base *container = ({ const typeof(((Base*)0)->a) *_ptr = (a_ptr); (Base*)((char*)(a_ptr) - ((size_t) &((Base*)0)->a));});
    
# 23 "tests/class.c" 3 4
   ((void) sizeof ((
# 23 "tests/class.c"
   &object == container
# 23 "tests/class.c" 3 4
...
# 23 "tests/class.c"
   "&object == container"
# 23 "tests/class.c" 3 4
   , "tests/class.c", 23, __extension__ __PRETTY_FUNCTION__); }))
# 23 "tests/class.c"
                               ;
}
